...
namespace Moonrise.Logging
{
    ...
    public class Logger : ILoggingProvider, IAuditProvider
    {
        ...
        /// </summary>
//        public static ILoggingProvider MainLogProvider => MainLogProvider;
        ...
        /// <summary>
        ///     Determines if <see cref="LogTag" />s are going to be utilised.
        /// </summary>
        /// <remarks>
        ///     If true, then for a log message to be emitted any associated <see cref="LogTag" /> must be currently active.
        ///     <para>
        ///         If false, then all log messages will be emitted.
        ///     </para>
        ///     <para>
        ///         Both cases, of course, being subject to the relevant <see cref="LoggingLevel" />.
        ///     </para>
        /// </remarks>
        public static bool UseLogTags { get; set; }
        ...
        public static void Audit(
            ...
            object anything,
            LogTag logTag = null,
            LoggingLevel auditLevel = LoggingLevel.Audit,
            [CallerMemberName] string caller = null)
        {
            try
            {
                ...
                LogMsgCommon(LoggingLevel.Audit,
                    auditMsg,
                    logTag,
                    caller);
                ...
                {
                    nextAuditor.AuditThisObject(message,
                        anything,
                        auditLevel,
                        ScopeContext.CurrentValue,
        ...
        /// <param name="callerContext">The caller context - defaults to the name of the caller</param>
        /// <returns>A <see cref="ScopeContext" /> that SHOULD be used in a using statement</returns>
        public static ScopeContext Context(LogTag logTagScope, [CallerMemberName] string callerContext = "") => new ScopeContext(callerContext, logTagScope);
        ...
        public static void Critical(string msg, [CallerMemberName] string caller = null)
        {
            ...
            LogMsgCommon(LoggingLevel.Critical,
                msg,
                null,
                caller);
        }
        ...
        public static void Debug(string msg, LogTag logTag = null, [CallerMemberName] string caller = null)
        {
            ...
            LogMsgCommon(LoggingLevel.Debug,
                msg,
                logTag,
                caller);
        }
        ...
        public static void Fatal(string msg, [CallerMemberName] string caller = null)
        {
            ...
            LogMsgCommon(LoggingLevel.Fatal,
                msg,
                null,
                caller);
        }
        ...
        public static void Info(string msg, LogTag logTag = null, [CallerMemberName] string caller = null)
        {
            ...
            LogMsgCommon(LoggingLevel.Information,
                msg,
                logTag,
                caller);
        }
        ...
        public static LocalLogger Local(ILoggingProvider localProvider) => new LocalLogger(localProvider);
        ...
        public static LogTag.Scoped ScopedLogTag(
            LogTag logTagScope = null,
            [CallerMemberName] string callerContext = "")
        {
            if (logTagScope == null)
        ...
        public static void Trace(string msg, LogTag logTag = null, [CallerMemberName] string caller = null)
        {
            ...
            LogMsgCommon(LoggingLevel.Trace,
                msg,
                logTag,
                caller);
        }
        ...
        public static void Warning(string msg, [CallerMemberName] string caller = null)
        {
            ...
            LogMsgCommon(LoggingLevel.Warning,
                msg,
                null,
                caller);
        }
        ...
        /// <param name="logTag">An optional log tag.</param>
        /// <param name="caller">The method name of the caller. Will be displayed if <seealso cref="LogMethodName" /> is true.</param>
        private static void LogMsgCommon(
            LoggingLevel level,
            string msg,
            LogTag logTag = null,
            string caller = null)
        {
            ...
            if (!UseLogTags || level > LoggingLevel.Information)
            ...
            if (OutputLevel <= (ReportingLevel)level && (logTag == null || logTag.IsActive()))
            {
                ...
                while (nextLogger != null && maxLoggers-- > 0)
                {
                    ...
                    lock (LockObject)
                    {
                        nextLogger.LogThis(level,
                            UseContext ? ScopeContext.CurrentValue : string.Empty,
                            UseThreadId ? $"{Thread.CurrentThread.ManagedThreadId}" : string.Empty,
                            logTag,
                            msg);
                    }

...
namespace Moonrise.Logging
{
    ...
    public class Logger : ILoggingProvider, IAuditProvider
    {
        ...
        /// </summary>
        public static ILoggingProvider MainLogProvider
        {
            get { return _OriginalLogger; }
        }
        ...
        {
            get { return _MaxChainedLoggers; }

            set
            {
                if (value < 1)
                {
                    throw new ArgumentOutOfRangeException("MaxChainedLoggers must be > 0");
                }
        ...
        /// <summary>
        ///     Logs a format-able message as a <see cref="LoggingLevel.Audit" />.
        ///     <remarks>
        ...
        [Obsolete("Please use interpolated strings version, this overload will soon be stripped out for ease of maintenance")]
        public static void Audit(string msg, params object[] args)
        {
            try
            {
                LogMsgCommon(LoggingLevel.Audit, msg, args);
                ...
                {
                    nextAuditor.AuditThis(msg);
                    nextAuditor = nextAuditor.NextAuditor;
                }
            }
            catch (Exception excep)
            {
                Error(excep, "Error auditing the following message [{0}]", msg);
        ...
        public static void Audit(string message, object anything, LoggingLevel auditLevel = LoggingLevel.Audit)
        {
            try
            {
                string auditMsg = auditLevel == LoggingLevel.Audit ? string.Empty : auditLevel + $" {message}\r\n{JsonIt(anything)}";

                LogMsgCommon(LoggingLevel.Audit, auditMsg);
                ...
                while ((nextAuditor != null) && (maxAuditors-- > 0))
                {
                    nextAuditor.AuditThisObject(message, anything, auditLevel);
                    nextAuditor = nextAuditor.NextAuditor;
                }
            }
            catch (Exception excep)
        ...
        ///     </para>
        ///     <para>
        ///         using (LoggerContext()){code} or LoggerContext("whatever")
        ///     </para>
        ///     <para>
        ...
        public static ScopeContext Context(string context = null, LogTag logTagScope = null, [CallerMemberName] string callerContext = "")
        {
            if (context == null)
            {
        ...
        /// </returns>
        public static ScopeContext Context(object[] arguments, LogTag logTagScope = null, [CallerMemberName] string context = "")
        {
            ScopeContext retVal;
        ...
        [SuppressMessage("StyleCop.CSharp.LayoutRules",
            "SA1503:CurlyBracketsMustNotBeOmitted",
            Justification = "I excuse exceptions and returns!")]
        public static void Debug(string msg, LogTag logTag = null)
        {
            if (Disabled)
            {
                return;
            ...
            LogMsgCommon(LoggingLevel.Debug, msg, logTag);
        }
        ...
        [SuppressMessage("StyleCop.CSharp.LayoutRules",
            "SA1503:CurlyBracketsMustNotBeOmitted",
            Justification = "I excuse exceptions and returns!")]
        public static void Debug(object anything, LogTag logTag = null)
        {
            if (Disabled)
            {
                return;
            ...
            LogMsgCommon(LoggingLevel.Debug, JsonIt(anything), logTag);
        }
        ...
        /// the stack trace.
        public static void Error(Exception excep, string msg = "")
        {
            if (Disabled)
            {
                return;
        ...
        [SuppressMessage("StyleCop.CSharp.LayoutRules",
            "SA1503:CurlyBracketsMustNotBeOmitted",
            Justification = "I excuse exceptions and returns!")]
        public static void Info(string msg, LogTag logTag = null)
        {
            if (Disabled)
            {
                return;
            ...
            LogMsgCommon(LoggingLevel.Information, msg, logTag);
        }
        ...
        [SuppressMessage("StyleCop.CSharp.LayoutRules",
            "SA1503:CurlyBracketsMustNotBeOmitted",
            Justification = "I excuse exceptions and returns!")]
        public static void Info(object anything, LogTag logTag = null)
        {
            if (Disabled)
            {
                return;
            ...
            LogMsgCommon(LoggingLevel.Information, JsonIt(anything), logTag);
        }
        ...
        public static string JsonIt(object anything)
        {
            ...
            try
            {
                if (anything != null)
                {
                    ...
                    retVal = string.Format("{0}:{1}", anything.GetType().FullName, JsonConvert.SerializeObject(anything, settings));
                }
                else
                {
                    retVal = "[Null object]";
        ...
        public static void LogActiveLogTags()
        {
            ...
            LogMsgCommon((LoggingLevel)OutputLevel, JsonIt(LogTag.ActiveLogTags));
        }
        ...
        [SuppressMessage("StyleCop.CSharp.LayoutRules",
            "SA1503:CurlyBracketsMustNotBeOmitted",
            Justification = "I excuse exceptions and returns!")]
        public static void MethodInfo(object[] arguments = null, LogTag logTag = null, [CallerMemberName] string methodName = "")
        {
        ...
        public static void Warning(string msg, params object[] args)
        {
            ...
            {
                LogMsgCommon(LoggingLevel.Warning, "Error logging the following warning [{0}]", msg);
            }
        }
        ...
        public static void Warning(string msg)
        {
            ...
            LogMsgCommon(LoggingLevel.Warning, msg);
        }
        ...
        [SuppressMessage("StyleCop.CSharp.LayoutRules",
            "SA1503:CurlyBracketsMustNotBeOmitted",
            Justification = "I excuse exceptions and returns!")]
        public static void Warning(object anything)
        {
            if (Disabled)
            {
                return;
            ...
            LogMsgCommon(LoggingLevel.Warning, JsonIt(anything));
        }
        ...
        private static void LogErrCommon(string msg, bool fatal = false)
        {
            if (fatal)
            {
                LogMsgCommon(LoggingLevel.Fatal, msg);
            }
            else
            {
        ...
        /// <param name="msg">Message to log.</param>
        /// <param name="logTag">An optional log tag.</param>
        private static void LogMsgCommon(LoggingLevel level, string msg, LogTag logTag = null)
        {
            if (logTag == null)
            {
            ...
            if ((OutputLevel <= (ReportingLevel)level) && ((logTag == null) || logTag.IsActive()))
            {
                LogMsgCommonCommon(level, msg, logTag);
            }
        }

        /// <summary>
        ///     The ACTUAL single point to call the log provider!
        /// </summary>
        /// <param name="level">The level for this message</param>
        /// <param name="msg">Message to log.</param>
        /// <param name="logTag">An optional log tag.</param>
        private static void LogMsgCommonCommon(LoggingLevel level, string msg, LogTag logTag)
        {
            if (logTag == null)
            {
                // If there isn't a log tag, check if a scope one has been used.
